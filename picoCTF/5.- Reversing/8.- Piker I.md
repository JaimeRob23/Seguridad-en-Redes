...
`$ nc saturn.picoctf.net 61690`

The program's source code can be downloaded [here](https://artifacts.picoctf.net/c/515/picker-I.py).

## Solucion
- Al ver el codigo proporcionado nos dimos cuenta que la palabra secreta era win y nos dio la flag pero en formato Hexadecimal, con cyberchef la desciframos y ya.
```
